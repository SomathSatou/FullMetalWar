#include "lignesandjoueur.h"


LigneSandJoueur::LigneSandJoueur(int numeroJoueur,QWidget *parent) : QWidget(parent), _numeroJoueur(numeroJoueur)
{
...
void LigneSandJoueur::nomChanged(const QString& nom){
    emit sendNom(_numeroJoueur,nom);
}

void LigneSandJoueur::couleurChanged(int indexCouleur){
    emit sendCouleur(_numeroJoueur,indexCouleur);
}

void LigneSandJoueur::PA_turnChanged(int value){
    emit sendPAturn(_numeroJoueur,value);
}

void LigneSandJoueur::PA_maxChanged(int value){
