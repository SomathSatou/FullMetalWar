#include "formulairecarte.h"

FormulaireCarte::FormulaireCarte(QWidget *parent) : QWidget(parent)
{
    ...
    setObjectName("FormulaireCarte");
    setStyleSheet("QWidget#FormulaireCarte { background-color : lightgrey; }");
